...
class GatePass(models.Model):
    _name = "requester.gate.pass"

    item = fields.Text(string="List Of Item")
    # item = fields.Many2many('res.partner',string="List Of Item")
    # item_reason = fields.Text(string="List Of Item")
